      ...
      <section className="bg-maroon-950 py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal duration={950} y={16}>
            <Link
              href="/bidang-praktik"
              className="font-label text-xs text-sand hover:text-ivory transition-colors mb-8 inline-flex items-center gap-1"
            >
              ← Semua Bidang Praktik
            </Link>
            <div className="flex items-start gap-5 mt-6">
              <div className="w-12 h-12 text-gold shrink-0 mt-1">
      ...
      <section className="bg-ivory py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal as="div" threshold={0}>
            <p className="font-body text-maroon-900/70 text-lg leading-relaxed mb-10 border-l-4 border-gold pl-6">
            ...
            {data.deskripsiLengkap && data.deskripsiLengkap.length > 0 ? (
              ...
              <p className="font-body text-maroon-900/40 italic">
                Deskripsi lengkap belum tersedia.
              </p>
            )}
          </Reveal>

          <Reveal as="div" className="mt-14 pt-8 border-t border-maroon-950/10" y={8} duration={580}>
            <p className="font-body text-maroon-950 font-medium mb-4">
