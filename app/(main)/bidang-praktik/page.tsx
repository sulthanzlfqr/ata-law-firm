              ...
              {list.map((b) => {
                ...
                return (
                  <Link
                    ...
                    className="group bg-white border border-navy-950/10 hover:border-terracotta/30 rounded-xl p-6 flex flex-col gap-5 transition-all hover:shadow-lg hover:shadow-navy-950/5"
                  >
