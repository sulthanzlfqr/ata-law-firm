...
export default async function KontakPage() {
  ...
  return (
    <>
      ...
      <section className="bg-maroon-950 pb-20 md:pb-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 pt-0">
            <Reveal as="div" className="lg:col-span-3" y={8} duration={580}>
              <div className="bg-maroon-900/50 border border-white/5 rounded-xl p-6 md:p-8">
            ...
            <Reveal as="div" className="lg:col-span-2 flex flex-col gap-8" y={8} duration={580} delay={120}>
              <div>
                <p className="font-label text-xs uppercase tracking-widest text-gold mb-5">
                  Informasi Kantor
                </p>
                <div className="flex flex-col gap-5">
                  {[
                    ...
                    <div key={item.label}>
                      <p className="font-label text-xs text-gold uppercase tracking-wide mb-1.5">
                        {item.label}
                      </p>
                      {item.href ? (
                        <a
              ...
              <a
                ...
                className="flex items-center justify-center gap-3 bg-gold text-white font-body font-medium px-6 py-4 rounded-lg hover:bg-gold/90 transition-colors"
              >
